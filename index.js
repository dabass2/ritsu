    ...
    if (botConfig.adminUsers.includes(message.author.id)) {
        ...
        if (cmd === "appraisal") {
            ...
            const embed = new Discord.MessageEmbed()
                ...
                .setDescription("There's a new chapter of Appraisal!!!!!! OMG POG!!")
                .addField("Read Chapter:", chapterLink)
                .addField("Next Chapter Release", "~1 week")
        ...
        if (cmd === "breakthrough") {
            ...
            const embed = new Discord.MessageEmbed()
                ...
                .setTitle("New Chapter")
                .setDescription("There's a new chapter of Breakthrough!!!!!! OMG POG!!")
                .addField("Read Chapter:", chapterLink)
        ...
        if (cmd === "shinja") {
            ...
            const embed = new Discord.MessageEmbed()
                ...
                .setTitle("New Chapter")
                .setDescription("There's a new chapter of Shinja!!!!!! OMG POG!!")
                .addField("Read Chapter:", chapterLink)
                .addField("Next Chapter Release", "~1 month")
                .addField("Comment", (comment ? comment : "No upload comment because nothing cool happened."))
                .setTimestamp(new Date())
